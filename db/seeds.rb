...
t7 = Task.create(title: 'Configuration Setup',
                 ...
                 updater_type: 'preliminary',
                 task_callbacks: 'hello_world')
t8 = Task.create(title: 'Test Title',
                 iteration: iteration,
                 description: 'Some contents about Task 8',
                 task_status: 'started',
                 updater_type: 'local',
                 task_callbacks: 'hello_world')
t10 = Task.create(title: 'Test Title',
                 iteration: iteration,
                 description: 'Some contents about Task 8',
                 task_status: 'started',
                 updater_type: 'local',
                 task_callbacks: 'hello_world')
t9 = Task.create(title: 'Test Title',
                 iteration: iteration,
                 description: 'Pass only get accepted by customers',
                 task_status: 'unstarted',
                 updater_type: 'local',
                 task_callbacks: 'hello_world')
t11 = Task.create(title: 'Test Title',
                 iteration: iteration,
                 description: 'Pass only get accepted by customers',
                 task_status: 'unstarted',
                  updater_type: 'local',
                 task_callbacks: 'hello_world')
t12 = Task.create(title: 'Test Title',
                 iteration: iteration,
                 description: 'Pass only get accepted by customers',
                 task_status: 'unstarted',
